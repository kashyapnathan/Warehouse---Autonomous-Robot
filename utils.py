...
class PidController():
    ...
    def __init__(self):
        ...
        self.linear_kp = 0.2
        self.linear_ki = 0.000
        self.linear_kd = 0.0

        self.angular_kp = 0.25
        self.angular_ki = 0.00
        self.angular_kd = 0.0
    ...
    def linear_controller(self, pose, goal_point):
        ...
        linear_velocity = (self.linear_kp * self.linear_error +
    ...
    def angular_controller(self, pose, waypoint):
        ...
        angular_velocity = (self.angular_kp * self.angular_error +
